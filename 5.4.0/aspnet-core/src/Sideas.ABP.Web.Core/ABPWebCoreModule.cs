...
using Sideas.ABP.Authentication.JwtBearer;
...
namespace Sideas.ABP
{
    ...
    public class ABPWebCoreModule : AbpModule
    {
        ...
        public ABPWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PostInitialize()
        {
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(ABPWebCoreModule).Assembly);
        }
    }
}
